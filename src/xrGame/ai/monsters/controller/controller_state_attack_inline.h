...
{
	this->add_state	(eStateAttack_HideInCover,		xr_new<CStateControlHide<_Object> >	(obj));
	this->add_state	(eStateAttack_HideInCoverLite,	xr_new<CStateControlHideLite<_Object> >	(obj));
	this->add_state	(eStateAttack_MoveOut,			xr_new<CStateControlMoveOut<_Object> >	(obj));
	this->add_state	(eStateAttack_CampInCover,		xr_new<CStateControlCamp<_Object> >		(obj));
	this->add_state	(eStateAttack_ControlFire,		xr_new<CStateControlFire<_Object> >		(obj));

	this->add_state	(eStateAttack_ControlTube,		xr_new<CStateControllerTube<_Object> >	(obj));
