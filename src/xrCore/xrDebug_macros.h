...
#	define R_CHK(expr)					do {static bool ignore_always = false; HRESULT _hr = expr; if (!ignore_always && FAILED(_hr)) ::Debug.error(_hr,_TRE(#expr),DEBUG_INFO,ignore_always);} while(0)
